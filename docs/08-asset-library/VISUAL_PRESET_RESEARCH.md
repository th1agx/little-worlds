...
| 3   | [Stylized Poly Nature Environment](https://www.lmhpoly.com/game-assets/stylized-poly-nature-environment) — LMHPOLY                                                                         | US$59,99; licença do canal de compra deve ser confirmada; **PROVAVELMENTE OK** para malhas, mas validar                                                                                                  | Unity e Unreal; Unity Standard/URP; FBX declarado pelo autor; sete demos e perfis de pós-processamento; [vídeo/tutorial](https://www.youtube.com/watch?v=zJJGXYATpCA)                                           | Água, vento, VFX e pós são específicos dos motores. A página informa FBX e documentação; caminho web é plausível, com materiais e atmosfera refeitos                    | **8 / 8 / 6 / 7 / 8**. Melhor equilíbrio entre biblioteca, demos e adaptação; menos pictórico que Dreamscape   |
