...
| Biblioteca de assets | [`08-asset-library/ASSET_LIBRARY.md`](08-asset-library/ASSET_LIBRARY.md)                                                 | curadoria oficial, catálogo, pipeline, licenças e fila de aquisição |
